...
const AdminPricing    = lazyPage("AdminPricing",    () => import("./pages/AdminPricing"));
const AdminProductImages = lazyPage("AdminProductImages", () => import("./pages/AdminProductImages"));
...
import AdminUserSubmittedNonprofits from "./pages/AdminUserSubmittedNonprofits";
      ...
      <AnimatePresence mode="wait">
        ...
        <Routes location={location} key={location.pathname}>
          ...
          <Route
            ...
            element={
              <RouteBoundary name="ProductSubcategory">
                <ProtectedRoute>
                  <ProductSubcategory />
                </ProtectedRoute>
              </RouteBoundary>
          ...
          <Route
            path="/donor-profile"
            element={
              <RouteBoundary name="DonorProfile">
                <ProtectedRoute>
                  <DonorProfile />
                </ProtectedRoute>
              </RouteBoundary>
          ...
          {/* Admin User Submitted Nonprofits */}
          <Route
            path="/admin/nonprofits/user-submitted"
            element={
              <RouteBoundary name="AdminUserSubmittedNonprofits">
                <AdminProtectedRoute>
                  <AdminUserSubmittedNonprofits />
                </AdminProtectedRoute>
              </RouteBoundary>
            }
          />
          ...
          {/* Admin Vendor Fulfillment */}
          <Route
            path="/admin/vendor-fulfillment"
            element={
