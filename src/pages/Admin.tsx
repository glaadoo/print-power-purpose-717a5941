          ...
          <Tabs defaultValue="dashboard" className="space-y-0">
            ...
            <section className="mb-12 md:mb-14">
              <div className="flex justify-center">
                <TabsList className="bg-transparent p-2 flex flex-wrap justify-center gap-2 max-w-5xl">
                  {[
                    ...
                    <TabsTrigger
                      key={tab.value}
                      value={tab.value}
                      className="rounded-full px-4 py-2 text-sm font-medium border border-white/30 bg-white/10 text-white hover:bg-white/20 data-[state=active]:bg-white/30 data-[state=active]:text-white data-[state=active]:border-white/50 transition-all duration-200"
                    >
                      {tab.label}
                    </TabsTrigger>
                  ))}
