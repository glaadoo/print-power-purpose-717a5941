      ...
      <div className="pt-14 min-h-screen overflow-y-auto scroll-smooth">
        ...
        <section className="py-16 md:py-24 px-4">
          <div className="max-w-5xl mx-auto">
            ...
            {/* Benefits Grid */}
            <div className="mb-8">
              <h2 className="text-2xl font-semibold text-white mb-6 text-center">How Nonprofits Benefit</h2>
            ...
            {/* Use Cases */}
            <div className="mb-8">
              <h2 className="text-2xl font-semibold text-white mb-6 text-center">Real-World Use Cases</h2>
            ...
            {/* Selection Steps */}
            <div className="bg-background/95 backdrop-blur-md rounded-2xl border border-border/20 shadow-xl p-6 md:p-8 mb-8">
              <h2 className="text-2xl font-semibold text-foreground mb-4">How Supporters Select Your Nonprofit</h2>
              <div className="space-y-4">
