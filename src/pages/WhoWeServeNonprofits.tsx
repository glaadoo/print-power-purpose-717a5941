          ...
          <div className="max-w-5xl mx-auto">
            <GlassCard className="p-8 md:p-12">
              <article className="prose prose-invert max-w-none">
                ...
                <section className="mb-12">
                  <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">How Nonprofits Benefit</h2>
                ...
                <section className="mb-12">
                  <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Real-World Use Cases</h2>
                ...
                <section className="mb-12">
                  <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">How Supporters Select Your Nonprofit</h2>
