...
export default function Donate() {
  ...
  // Success handling moved to Home page
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 border border-white/20 rounded-lg overflow-hidden">
                  <button 
                    ...
                    disabled={processing}
                    className={`w-full p-4 transition-colors flex items-center gap-3 text-left border-b border-white/10 disabled:opacity-50 disabled:cursor-not-allowed ${
                  ...
                  <button 
                    ...
                    disabled={processing}
                    className={`w-full p-4 transition-colors flex items-center gap-3 text-left disabled:opacity-50 disabled:cursor-not-allowed ${
                ...
                {selectedPaymentMethod && (
                  ...
                  >
                    {processing ? 'Processing...' : 'Proceed for Payment'}
                  </Button>
                )}
