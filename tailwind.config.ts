    ...
    extend: {
      ...
      keyframes: {
        ...
        "paw-step-3": {
          ...
          "85%": { opacity: "0.8", transform: "scale(0.95)" },
          "95%": { opacity: "0", transform: "scale(0.7)" },
          "100%": { opacity: "0", transform: "scale(0.5)" },
        },
        "paw-wiggle": {
          "0%, 100%": { transform: "rotate(0deg)", opacity: "0.9" },
          "25%": { transform: "rotate(-10deg)", opacity: "1" },
          "75%": { transform: "rotate(10deg)", opacity: "1" },
        },
        "draw-line": {
      ...
      animation: {
        ...
        "kenzie-blink": "kenzie-blink 4s ease-in-out infinite",
